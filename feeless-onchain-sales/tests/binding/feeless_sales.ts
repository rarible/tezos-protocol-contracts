...
export class sale implements ex.ArchetypeType {
    constructor(public sale_asset_contract: ex.Address, public sale_asset_token_id: ex.Nat, public sale_seller: ex.Address, public sale_type: asset_type, public sale_asset: ex.Bytes, public sale_origin_fees: Array<part>, public sale_payouts: Array<part>, public sale_amount: ex.Nat, public sale_asset_qty: ex.Nat, public sale_start: ex.Option<Date>, public sale_end: ex.Option<Date>, public sale_max_fees_base_boint: ex.Nat, public sale_data_type: ex.Option<ex.Bytes>, public sale_data: ex.Option<ex.Bytes>) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): ex.Micheline {
        return ex.pair_to_mich([this.sale_asset_contract.to_mich(), ex.pair_to_mich([this.sale_asset_token_id.to_mich(), ex.pair_to_mich([this.sale_seller.to_mich(), ex.pair_to_mich([this.sale_type.to_mich(), ex.pair_to_mich([this.sale_asset.to_mich(), ex.pair_to_mich([ex.list_to_mich(this.sale_origin_fees, x => {
                                    return x.to_mich();
...
export const sale_mich_type: ex.MichelineType = ex.pair_array_to_mich_type([
    ...
    ex.pair_array_to_mich_type([
        ...
        ex.pair_array_to_mich_type([
            ex.prim_annot_to_mich_type("address", ["%sale_seller"]),
            ex.pair_array_to_mich_type([
